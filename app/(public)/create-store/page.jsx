...
export default function CreateStore() {
    ...
    try {
      ...
      if (["pending", "approved", "rejected"].includes(data.status)) {
        ...
        if (data.status === "pending") {
          ...
          setMessage(
            "We're sorry, but your store application was rejected. Please review the guidelines and consider reapplying.",
          );
        }
      } else {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (!user) {
      return toast("Please login to create a store", { icon: "❌" });
    }
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on BuyBuddy, submit your store details for
